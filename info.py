...
# Bot information
API_ID = environ.get('API_ID', '27394279')
if len(API_ID) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002389608376').split()]
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002326865341')
...
if len(DATA_DATABASE_URL) == 0:
    ...
    exit()
FILES_DATABASE_URL = environ.get('FILES_DATABASE_URL', "mongodb+srv://Strange:Strange@cluster0.wpvqktw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
if len(FILES_DATABASE_URL) == 0:
    logger.error('FILES_DATABASE_URL is missing, exiting now')
    exit()
SECOND_FILES_DATABASE_URL = environ.get('SECOND_FILES_DATABASE_URL', "mongodb+srv://Strange:Strange@cluster0.wpvqktw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
PM_FILE_DELETE_TIME = int(environ.get('PM_FILE_DELETE_TIME', '86400'))
